    ...
    return (
        <aside className="w-64 border-r border-border bg-white flex flex-col h-screen shrink-0">
            ...
            <div className="px-6 py-4 flex items-center">
                <a href="https://phanmemauto.com/">
                    <img src="https://phanmemauto.com/wp-content/themes/sd-automation/assets/images/logo-pmauto.png" alt="Phần Mềm Auto" className="h-10 w-auto object-contain" />
                </a>
            </div>
